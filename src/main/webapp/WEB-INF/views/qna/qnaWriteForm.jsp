...
<body>
	...
	<form id="write_form" action="qnaWrite.do"  enctype="multipart/form-data" method="post"  >
		<div class="WritingContent" style="padding-top:75px">
			...
			<div>
				<div class="FlexableTextArea">
					<input type="text" name="title" id="title" class="textarea_input" placeholder="제목을 입력해 주세요.">
				</div>
			...
			<div style="text-align:center">
					...
					<input class="btn btn-secondary" type="button" value="취소" onclick="location.href='qnaList.do';">
			</div>
		</div>
	</form>
	</div>

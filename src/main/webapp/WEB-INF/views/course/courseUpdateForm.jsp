		...
		<ul>
			<li>
				...
				<input type="text" name="title" id="title" 
				                     value="${jboard_course.title}" maxlength="50">
			</li>
			<li>
				<label for="content">내용</label>
				<textarea rows="5" cols="30" name="content" 
				                   id="content">${jboard_course.content}</textarea>
			</li>
			<li>
				...
				<br>
				<span id="file_detail">
					(${jboard_course.filename})파일이 등록되어 있습니다. 
...
<script type="text/javascript">
	$(function(){
		$('#file_del').click(function(){
			...
			if(choice){
				$.ajax({
					url:'courseDeleteFile.do',
					type:'post',
					data:{course_num:${jboard_course.course_num}},
					dataType:'json',
					cache:false,
					timeout:30000,
